...
class _AnimatedNotchBottomBarState extends State<AnimatedNotchBottomBar> {
  ...
  void didChangeDependencies() {
    ...
    _screenWidth = widget.width ?? MediaQuery.of(context).size.width;
  }
                        ...
                        children: <Widget>[
                          ...
                          for (var i = 0;
                            ...
                            if (i == currentIndex)
                              Positioned(
                                ...
                                child: BottomBarActiveItem(
                                  i,
                                  itemWidget:
                                      widget.bottomBarItems[i].activeItem,
                            ...
                            if (i != currentIndex)
                              Positioned(
                                top:
                                    kMargin + (kHeight - kCircleRadius * 2) / 2,
  ...
  double _firstItemPosition() {
    return (_screenWidth - kMargin * 2) *
        (0.30 - widget.bottomBarItems.length * 0.05);
  }
